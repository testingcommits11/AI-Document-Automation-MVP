    ...
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-line p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-inksoft text-sm mt-1">
              Login is only required for custom field management.
            </p>
          </div>
        ...
        >
          ...
          {error && (
            <div className="rounded-xl border border-red-100 bg-red-50 text-red-600 px-3 py-2.5 text-sm">
              {error}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full bg-primary hover:bg-primary/90 text-white font-semibold rounded-xl py-3 disabled:opacity-50"
          >
            {busy
              ? "Please wait..."
              : mode === "login"
